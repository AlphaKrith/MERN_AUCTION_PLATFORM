    ...
    <>
      ...
      >
        ...
        <div className="flex items-center pb-3">
          <img
            src="/logo.jpg"
            className="h-[80px] rounded-full border-2 border-gray-300 shadow-lg hover:scale-105 transition-transform duration-300"
            alt="Logo"
          />
        </div>
          <Link to={"/"}>
          ...
          {!isAuthenticated ? (
            <>
              <div className="my-4 flex gap-2">
                ...
                <Link
                  to={"/login"}
                  className="text-[#DECCBE] bg-transparent border-[#DECCBE] border-2 hover:bg-[#fffefd] hover:text-[#fdba89] font-bold text-xl py-1 px-4 rounded-md"
                >
                  Login
                </Link>
              </div>
        ...
        <div>
          <div className="flex gap-2 items-center mb-2">
            <Link
              to="https://www.linkedin.com/in/kritarth-soni-9a2656236"
              className="bg-white text-stone-500 p-2 text-xl rounded-sm hover:text-blue-700"
            >
              <FaLinkedin />
            </Link>
            <Link
              to="https://www.instagram.com/soni_kritarth/"
