...
const AuctionItem = () => {
  ...
  const handleBid = () => {
    if (amount <= 0) {
      return alert("Please enter a valid bid amount!"); // Simple validation for demonstration
    }
    const formData = new FormData();
    formData.append("amount", amount);
    dispatch(placeBid(id, formData));
    dispatch(getAuctionDetail(id)); // Refresh auction details after placing a bid
  };
  ...
  }, [isAuthenticated, id, dispatch, navigateTo]); // Added `id`, `dispatch`, and `navigateTo` as dependencies
        ...
        {loading ? (
          ...
          <div className="flex gap-4 flex-col lg:flex-row">
            <div className="flex-1 flex flex-col gap-3">
              <div className="flex gap-4 flex-col lg:flex-row">
                ...
                <div className="flex flex-col justify-around pb-4">
                  ...
                  <p className="text-xl font-semibold italic  text-stone-600">
                    Condition:{" "}
            ...
            <div className="flex-1">
              <header className="bg-stone-200 italic py-4 text-[24px] font-semibold px-4">
                BIDS:
              </header>
