  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col min-h-screen py-4 justify-start">
        <div className="bg-white mx-auto w-full h-auto px-2 flex flex-col gap-4 items-center py-4 justify-center rounded-2xl">
          <form
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={7}
                className="text-[16px] py-2 bg-transparent border-[1px] px-1 rounded-md border-b-stone-500 focus:outline-none"
              />
            </div>


            <button
              className="bg-[#d6482b] font-semibold hover:bg-[#b8381e] text-xl transition-all mx-auto duration-300 py-2 px-4 rounded-md text-white my-4"
              type="submit"
            >
